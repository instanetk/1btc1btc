...
const LOGO =
  '<svg x="525" y="35" width="150" height="73" viewBox="170 330 685 332">' +
...
function buildSvg(tokenId: number, text: string): string {
  return (
    ...
    LOGO +
    `<text x="${CX}" y="130" text-anchor="middle" fill="#F7931A" opacity="0.5" font-family="sans-serif" font-size="16" textLength="180" lengthAdjust="spacing">1 BTC = 1 BTC</text>` +
