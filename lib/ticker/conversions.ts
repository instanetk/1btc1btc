...
export interface TickerItem {
  ...
  unit: string;
  tooltip: string;
  category: "live" | "historical" | "absurd" | "punchline" | "nft";
  href?: string;
}
...
export interface ConversionDef {
  ...
  compute: (btcUsd: number, prices?: CommodityPrices) => number;
}
...
export const liveConversions: ConversionDef[] = [
  ...
  },
  {
    ...
    category: "live",
    compute: (_btc, prices) => prices?.btcGoldOz ?? _btc / 2400,
  },
  {
    id: "bigmac",
    unit: "Big Macs",
  ...
  },
  {
    ...
    category: "live",
    compute: (_btc, prices) => prices?.btcSilverOz ?? _btc / 32,
  },
  {
    id: "farmland",
